    ...
    Dialog(onDismissRequest = { onDismissRequest() }) {
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    value = luas,
                    onValueChange = { luas = it },
                    label = { Text(text = stringResource(id = R.string.luas)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(judul, luas, harga.toDouble(), bitmap) },
                        enabled = judul.isNotEmpty() && luas.isNotEmpty() && (harga.toDoubleOrNull() != null && harga.toDouble()  >= 1.0) && (desain != null || bitmap != null),
                        modifier = Modifier.padding(8.dp)
                    ) {
